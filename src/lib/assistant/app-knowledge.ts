...
export const APP_MODULES: AppModule[] = [
  {
    ...
    features: [
      "KPIs financieros y comerciales, incluyendo oportunidades activas y acciones CRM pendientes",
  ...
  },
  {
    ...
    route: "/crm",
    status: "REAL",
    description: "Pipeline comercial desde nuevo contacto hasta cobro, con oportunidades, valor estimado, próxima acción, tareas e historial.",
    features: [
      "Etapas: nuevo, contactado, visita, presupuesto, aceptado, trabajo, facturado y cobrado",
      "Valor estimado, origen, próxima acción y fecha",
      "Tareas y recordatorios",
      "Historial de actividad por cliente y oportunidad",
      "Conversión de lead a cliente y oportunidad",
    ],
    limitations: ["Los cambios de etapa son manuales; no alteran automáticamente estados fiscales"],
    usage: "Ve a /crm para gestionar el pipeline. La ficha del cliente muestra sus oportunidades, tareas e historial.",
  },
  {
    name: "Leads",
    route: "/leads",
    ...
    features: [
      ...
      "Conversión atómica a cliente y oportunidad CRM",
    ],
    limitations: [],
    usage: "Ve a /leads. Registra el contacto y usa la acción de conversión para crear el cliente y su oportunidad CRM.",
  },
  {
    name: "Presupuestos",
    route: "/presupuestos",
    ...
    features: [
      ...
      "Crear parte de trabajo directamente desde el listado o detalle",
  ...
  },
  {
    ...
    features: [
      ...
      "Generar factura directamente desde el listado o detalle",
  ...
  },
  {
    ...
    limitations: [
      ...
      "No se puede verificar envío, entrega o lectura mediante wa.me",
    ],
