...
function ParteTrabajoDetail() {
  ...
  // Total hours: sum ALL trabajo quantities (this table is mano de obra)
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-6 md:p-10 print:shadow-none print:border-none print:p-0 print:rounded-none max-w-4xl mx-auto">
              ...
              <tfoot>
                ...
                {totalHoras > 0 && (
                  <tr className="bg-slate-50">
                    <td colSpan={5} className="px-2 py-1.5 text-xs font-semibold text-slate-700 text-right">Total horas:</td>
        ...
        <div className="mb-6 p-4 border border-slate-200 rounded-lg">
          ...
          <div className="max-w-xs ml-auto space-y-1.5 text-sm">
            ...
            {totalHoras > 0 && (
              <div className="flex justify-between font-semibold"><span className="text-slate-700">Total horas</span><span>{totalHorasLabel} h</span></div>
            )}
