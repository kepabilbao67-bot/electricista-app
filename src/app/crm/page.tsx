    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <form onSubmit={createOpportunity} className="card grid gap-4 p-5 md:grid-cols-2">
          ...
          <div><label className="mb-1 block text-sm font-medium">Valor estimado</label><input className="input-field" type="number" min="0" step="0.01" value={form.estimated_value} onChange={(e) => setForm({ ...form, estimated_value: e.target.value })} /></div>
